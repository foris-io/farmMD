    ...
    window.onload = function () {
      var chart = new CanvasJS.Chart("chartContainer", {
        ...
        data: [
        {
          ...
          color: "#3498DB",
          dataPoints: [
          { x: new Date(2010, 0, 3), y: 73 },
          { x: new Date(2010, 0, 5), y: 70 },
          { x: new Date(2010, 0, 7), y: 68 },
          { x: new Date(2010, 0, 9), y: 53 },
          { x: new Date(2010, 0, 11), y: 80 },
          { x: new Date(2010, 0, 13), y: 77 },
          { x: new Date(2010, 0, 15), y: 62 },
          { x: new Date(2010, 0, 17), y: 60 },
          { x: new Date(2010, 0, 19), y: 72 },
          { x: new Date(2010, 0, 21), y: 62 },
          { x: new Date(2010, 0, 23), y: 63 }
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"></i> <span><img src="images/forisLogo.png" alt="Logo" height="42" width="150"align="middle" style="margin:0px 28px">
              </span></a>
            </div>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Water Consumption <small>Real Time Data Obtained from Meters</small></h3>
              </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Water Consumption(Gallons) </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" ">73%</td>
                            <td class=" ">Jan 3, 2014 11:47:56 PM </td>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" ">70%</td>
                            <td class=" ">Jan 5, 2014 11:30:12 PM</td>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">68%</td>
                            <td class=" ">Jan 7, 2014 10:55:33 PM</td>
                         <!--    <td class=" ">121000203 <i class="success fa fa-long-arrow-up"></i>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" ">53%</td>
                            <td class=" ">Jan 9, 2014 10:52:44 PM</td>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">80%</td>
                            <td class=" ">Jan 11, 2014 11:47:56 PM </td>
                          ...
                          <tr class="odd pointer">
                            ...
                            <td class=" ">77%</td>
                            <td class=" ">Jan 13, 2014 11:30:12 PM</td>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">62%</td>
                            <td class=" ">Jan 15, 2014 10:55:33 PM</td>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">60%</td>
                            <td class=" ">Jan 17, 2014 10:55:33 PM</td>
                            <!-- <td class=" ">121000203</td>
                            <td class=" ">Mike Smith</td>
                            <td class=" ">Paid</td> -->
                            <!-- <td class="a-right a-right ">$432.26</td> -->
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">72%</td>
                            <td class=" ">Jan 19, 2014 10:55:33 PM</td>
                            <!-- <td class=" ">121000203</td>
                            <td class=" ">Mike Smith</td>
                            <td class=" ">Paid</td> -->
                            <!-- <td class="a-right a-right ">$432.26</td> -->
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">62%</td>
                            <td class=" ">Jan 21, 2014 10:55:33 PM</td>
                            <!-- <td class=" ">121000203</td>
                            <td class=" ">Mike Smith</td>
                            <td class=" ">Paid</td> -->
                            <!-- <td class="a-right a-right ">$432.26</td> -->
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" ">63%</td>
                            <td class=" ">Jan 23, 2014 10:55:33 PM</td>
                            <!-- <td class=" ">121000203</td>
                            <td class=" ">Mike Smith</td>
                            <td class=" ">Paid</td> -->
                            <!-- <td class="a-right a-right ">$432.26</td> -->
