          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Salinity <small>Real Time Data Obtained from Meters</small></h3>
              </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Salinity </th>
                        ...
                        <tbody>
                         ...
                         for ($x = 0; $x < count($json); $x++) {
                           ...
                           $str = "<td class='a-center '><input type='checkbox' class='flat' name='table_records'></td><td class=' '>" . 				   $Salinity . "</td><td class=' '>" . $timestamp . "</td><td class=' last'><a href='#'>View</a></td></tr>";

                         //echo $str;

                            if($x % 2 == 0)
                            {
                               $str = "<tr class='odd pointer'>" . $str;
                            }  
                            else
                            {
                               $str = "<tr class='even pointer'>" . $str;
                            }
