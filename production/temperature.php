...
for ($x = 0; $x < count($json); $x++) {
    ...
    //$moisture = $json[0]->sensor->Moisture;
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Temperature <small>Real Time Data Obtained from Meters</small></h3>
              </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                         ...
                         for ($x = 0; $x < count($json); $x++) {
                           ...
                           $str = "<td class='a-center '><input type='checkbox' class='flat' name='table_records'></td><td class=' '>" . 				   $Ph . "</td><td class=' '>" . $timestamp . "</td><td class=' last'><a href='#'>View</a></td></tr>";
